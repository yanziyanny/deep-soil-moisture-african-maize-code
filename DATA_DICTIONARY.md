...
| `supplement/data/figures/s3_*` through `s10_*` | Figure-ready supplement panels copied by the supplement runner | Supplementary Figures S3-S10 | PNG/PDF image files | figure-ready visual outputs | processed figure outputs | supplement figure reproduction |
