...
| `supplement/data/figures/supplementary_figure_s*` | Figure-ready supplement panels copied by the supplement runner | Supplementary Figures S3-S10 | PNG/PDF image files | figure-ready visual outputs | processed figure outputs | supplement figure reproduction |
...
| `supplement/data/gldas_sif/koppen*/results.json` | GLDAS Noah SIF attribution summaries by climate zone | Supplementary Figure S7 | `metrics`, `drop_group_delta`, `drop_column_delta`, `shap_feature`, `shap_group` | R2, Delta R2, attribution summaries | processed summary JSON | supplement source data |
