...
| `figure4/data/koppen*/results.json` | Packaged model results by climate zone | Figure 4, Supplement S8 | `metrics`, `drop_group_delta`, `drop_column_delta`, bootstrap CI fields, `shap_feature`, `shap_group`, `partial_r2` | R2, Delta R2, model metrics | summary data | default figure and supplement reproduction |
...
| `supplement/data/shapley_r2/s9_shapley_group_decomposition.csv` | Shapley R2 group decomposition | Supplementary Figure S9 | `full_model_r2`, `feature_group`, `shapley_r2`, `share_percent`, CI columns | R2, percent | processed summary table | supplement reproduction |
| `supplement/data/hard_energy_filtering/s10_hard_energy_filtering_sensitivity.csv` | Hard energy-filtering sensitivity summary | Supplementary Figure S10 | `test_r2`, `delta_energy`, `delta_surface`, `delta_rootwater`, `sw_threshold`, `tmax_threshold` | R2, Delta R2, thresholds | processed summary table | supplement reproduction |
